...
router.use('/hubs', authRefreshMiddleware);
...
router.get('/hubs/:hub_id/projects/:project_id/contents', async function (req, res, next) {
    try {
...
router.get('/hubs/:hub_id/projects/:project_id/contents/:item_id/versions', async function (req, res, next) {
    try {
